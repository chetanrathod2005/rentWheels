...
<h2>Four Wheeler Booking Request</h2>
...
if($result->num_rows > 0) {
    ...
    <table border='1' class='list_table' id='fw_booking'>
...
function action(id) {
    ...
    fetch("four_wheeler/fw_booking/action_fw.php?id=" + id)
...
document.addEventListener("submit", function (e) {
    ...
    if (e.target && e.target.id == "action_data") {
        ...
        fetch("four_wheeler/fw_booking/update_booking.php", {
...
function viewMore(id) {
    ...
    fetch("four_wheeler/fw_booking/booking_details.php?id=" + id)
