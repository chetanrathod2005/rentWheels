 <h2>Two Wheeler Booking Report</h2>
    ...
    if ($result->num_rows > 0) {
        ...
        while ($search = $result->fetch_assoc()) {
            ...
            <tr>
                ...
                <td>{$search['bike_name']}</td>

                <td>{$search['bike_rent']}</td>
...
const bookFrom = document.getElementById("book_from");

const bookTo = document.getElementById("book_to");
